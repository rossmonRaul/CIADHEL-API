...
const putAnAirport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let { //variables
        Usario, Nombre_OACI, NombreICAO, Estado_Aeropuerto, Notam, Publico, Controlado, Coordenada, Info_Torre, Info_General, Espacio_Aereo, Combustible, Norma_General, Norma_Particular, Direccion_Exacta, Numero_Telefono1, Numero_Telefono2, Horario, ATIS, GRND, TWR, EMERGENCY, Otras, Pista, Elevacion, Superficie_Pista, ASDA_Rwy_1, ASDA_Rwy_2, TODA_Rwy_1, TODA_Rwy_2, TORA_Rwy_1, TORA_Rwy_2, LDA_Rwy_1, LDA_Rwy_2, } = req.body;
