...
exports.default = {
    ...
    user_db: ((_a = process.env.USER_DB) === null || _a === void 0 ? void 0 : _a.toString()) || '',
    pass_db: ((_b = process.env.PASSWORD_DB) === null || _b === void 0 ? void 0 : _b.toString()) || '',
    server_db: ((_c = process.env.SERVER_DB) === null || _c === void 0 ? void 0 : _c.toString()) || '',
    name_db: ((_d = process.env.NAME_DB) === null || _d === void 0 ? void 0 : _d.toString()) || '',
